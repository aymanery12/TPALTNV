error id: file://<WORKSPACE>/TPALT_Backend/src/main/java/com/bookstore/Controller/AdminController.java:_empty_/BookRepository#decrementStock#
file://<WORKSPACE>/TPALT_Backend/src/main/java/com/bookstore/Controller/AdminController.java
empty definition using pc, found symbol in pc: _empty_/BookRepository#decrementStock#
empty definition using semanticdb
empty definition using fallback
non-local guesses:

offset: 10424
uri: file://<WORKSPACE>/TPALT_Backend/src/main/java/com/bookstore/Controller/AdminController.java
text:
```scala
